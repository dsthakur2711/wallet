...
import (
	...
	model "github.com/dsthakur2711/wallet/model"
	mock "github.com/stretchr/testify/mock"

	store "github.com/dsthakur2711/wallet/store"
)
...
// AddMoney provides a mock function with given fields: ctx, address1, amount1, address2, amount2
func (_m *WalletRepo) AddMoney(ctx context.Context, address1 string, amount1 int64, address2 string, amount2 int64) (model.Wallet, model.Wallet, error) {
	ret := _m.Called(ctx, address1, amount1, address2, amount2)

	var r0 model.Wallet
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, string, int64) model.Wallet); ok {
		r0 = rf(ctx, address1, amount1, address2, amount2)
	} else {
		r0 = ret.Get(0).(model.Wallet)
	}

	var r1 model.Wallet
	if rf, ok := ret.Get(1).(func(context.Context, string, int64, string, int64) model.Wallet); ok {
		r1 = rf(ctx, address1, amount1, address2, amount2)
	} else {
		r1 = ret.Get(1).(model.Wallet)
	}

	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, string, int64, string, int64) error); ok {
		r2 = rf(ctx, address1, amount1, address2, amount2)
	} else {
		r2 = ret.Error(2)
	}
...
// AddWalletBalance provides a mock function with given fields: ctx, params
func (_m *WalletRepo) AddWalletBalance(ctx context.Context, params store.AddWalletBalanceParams) (model.Wallet, error) {
	ret := _m.Called(ctx, params)

	var r0 model.Wallet
	if rf, ok := ret.Get(0).(func(context.Context, store.AddWalletBalanceParams) model.Wallet); ok {
		r0 = rf(ctx, params)
	} else {
		r0 = ret.Get(0).(model.Wallet)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, store.AddWalletBalanceParams) error); ok {
		r1 = rf(ctx, params)
	} else {
		r1 = ret.Error(1)
	}
